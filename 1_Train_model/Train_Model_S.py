...
START_ITER = 17000      # Set 0 for from scratch, else will load saved params and trains further
NB_ITER = 200000    # Total number of training iterations

I_DISPLAY = 100     # display info every N iteration
I_VALIDATION = 1  # validate every N iteration
I_SAVE = 1000       # save models every N iteration

TRAIN_DIR = './train/'  # Training images: jpg files should just locate in the directory (eg ./train/img0001.jpg ... ./train/img0800.jpg)
